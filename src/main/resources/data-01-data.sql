...
VALUES ('Club Omnisports Paris Centre', '2010-01-15', '2024-01-10', '1', 'Place du Sport', '75001', 'Paris',
        '0102030405', 'contact@csc-paris.fr', "CLUB-0001"), -- ID: 1
       ('Lyon Padel Club', '2018-06-01', '2025-01-01', '200', 'Avenue Padel', '69007', 'Lyon', '0477889900',
        'contact@lyonpadel.fr', "CLUB-0002");
-- ID: 2
...
INSERT INTO reservations (membre_id, event_id, categorie_id, date_reservation, reservation_uuid)
VALUES (1, 1, 1, '2025-02-01 10:00:00', UUID()), -- Alice (Admin) au tournoi passé
       (3, 1, 2, '2025-02-02 11:00:00', UUID()), -- Bob (Membre) au tournoi passé
       (1, 2, 3, '2025-03-01 10:00:00', UUID()), -- Alice (Admin) à la soirée passée
       (3, 2, 3, '2025-03-01 11:00:00', UUID()), -- Bob (Membre) à la soirée passée
       (6, 3, 4, '2025-05-01 09:00:00', UUID()), -- Franck (Admin C2) au tournoi Lyon
       (5, 3, 4, '2025-05-02 10:00:00', UUID()), -- Eva (Membre C2) au tournoi Lyon
       (1, 4, 5, '2025-04-20 14:00:00', UUID());
